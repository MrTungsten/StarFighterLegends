...
public class PlayerScript : MonoBehaviour
{
    ...
    private PolygonCollider2D laserCollider = null;
...
<<<<<<< HEAD
        laserCollider = laser.GetComponent<PolygonCollider2D>();
=======
        laserCollider = laser.GetComponent<Collider2D>();
>>>>>>> 1a0d2a3c2dc8a3f34d05f415d5a981ed319b1985
    ...
    private void Update()
    {
        ...
        if (isLaserOn)
        {
            ...
            List<Vector2> listOfPoints = laserCollider.GetPath(1).ToList();
            listOfPoints[1] = new Vector2(listOfPoints[1].x, laser.transform.InverseTransformPoint(new Vector3(0, 15f, 0)).y);
            listOfPoints[2] = new Vector2(listOfPoints[2].x, laser.transform.InverseTransformPoint(new Vector3(0, 15f, 0)).y);

            laserCollider.SetPath(1, listOfPoints);
